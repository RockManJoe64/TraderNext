...
WORKDIR /src
COPY ["TraderNext.csproj", "TraderNext/"]
RUN dotnet restore "TraderNext/TraderNext.csproj"

WORKDIR "/src/TraderNext"
COPY . .
RUN dotnet build "TraderNext.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "TraderNext.csproj" \
...
Execute unit tests
```
    cd "TraderNext/test/TraderNext.Tests"
    dotnet test
```
